V1 Momentum Strategy — Quantitative Long/Short Trading System
...
Objectif du Projet
Système de trading quantitatif Long/Short Momentum sur un univers d'actions multi-indices avec position sizing dynamique et risk management.
...
Volume : ~7+ millions de lignes de prix historiques sur plus de 5 indices avec l'entièreté des actions dedans
Qualité : Nettoyage automatique, standardisation, filtre minimum de trading days, choix de l'indice et du split de périodes
...
Coefficient de détermination pour valider la linéarité du trend avec autocorrélation (minimum requis adaptable)
...
Transaction Costs : Intégrés dans le backtesting pour simuler les frais au passage d'ordres
...
Objectif : Vérifier que la stratégie performe de manière cohérente sur différents régimes de marché et sur différents cycles.
...
└──────────────────────────────────────────────────────────────────────────────┘
 ...
 Génération des graphiques...
    Dashboard sauvegardé: /Users/lorisbouvier/Desktop/V1_RESULTS/graphs/Momentum_Advanced_Full_Dashboard.png
    Trades sauvegardés: /Users/lorisbouvier/Desktop/V1_RESULTS/Momentum_Advanced_Full_trades.csv
    Métriques sauvegardées: /Users/lorisbouvier/Desktop/V1_RESULTS/Momentum_Advanced_Full_metrics.txt
...
================================================================================
 ...
 Fichiers sauvegardés dans: /Users/lorisbouvier/Desktop/V1_RESULTS
